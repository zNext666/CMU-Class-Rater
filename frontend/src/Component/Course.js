...
class Course extends Component{
    ...
    getCourse = async() =>{
        try {
            const increaseView = await axios.post('https://cmuclassrater.engineer/api/course/' + this.state.course_no + '/view', {course_no:this.state.course_no})
            const response = await axios.get('https://cmuclassrater.engineer/api/course/' + this.state.course_no)
    ...
    getAvg = async() =>{
        try {
            const response = await axios.get('https://cmuclassrater.engineer/api/reviews/' + this.state.course_no + '/summary/average')
            const data = await response.data
    ...
    getSum = async() =>{
        try {
            const response = await axios.get('https://cmuclassrater.engineer/api/reviews/' + this.state.course_no + '/summary')
            const data = await response.data
