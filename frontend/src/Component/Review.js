...
class Review extends Component{
    ...
    async onSubmit(e){
        ...
        {
            const res = await axios.post('https://cmuclassrater.engineer/api/review/course', ncomment)
    ...
    getComment = async() =>{
        try {
            const response = await axios.get('https://cmuclassrater.engineer/api/reviews/' + this.state.course_no)
